...
processIndex :: Block -> Md5Digest -> Int -> Reader Config Md5Digest
processIndex blk digest i
    -- Round 1
...
processBlock digest block = do
        resultDigest <- foldlM (processIndex block) digest [0..63]
